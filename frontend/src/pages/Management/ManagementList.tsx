...
const ManagementList: React.FC<Props> = ({ rootStore }) => {
                                    ...
                                    userList.length === 0 ?
                                        ...
                                        userList.map((data: Management) => {
                                            return <tr key={uuidv4()}>
                                                ...
                                                <td>
                                                    {userRole === 'admin' &&
                                                        <Link to={`/edit-profile/management/${data._id}`} className='mr-2 action_info'>
                                                            <img src={editIcon} alt="Edit icon" />
                                                        </Link>}
                                                    <Link to={`/management/detail/${data._id}`}>
                                                        View Profile
                                                    </Link>
                                                </td>
                                            </tr>
...
export default observer(ManagementList);