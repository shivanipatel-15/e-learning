...
import { importTeachers  } from '../../api/userAction'

interface Props {
    rootStore: RootStore
}

const TeacherImport: React.FC<Props> = ({ rootStore }) => {
    const {
        register,
        handleSubmit,
        formState: { errors },
    ...
    const onSubmit = async (data: any) => {
        ...
        try {
            const response = await importTeachers(postData)
                ...
                <div className="card add_timetable_card ">
                    <div className="card-body add_timetable_cardbody">
                        <div className='d-flex justify-content-between'>
                            <h5 className="card-title"><HistoryBack /> Import Teacher</h5>
                            <a href='./../../csv/teacher_import.csv'
