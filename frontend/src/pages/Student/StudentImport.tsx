...
import { importStudents  } from '../../api/userAction'

interface Props {
    rootStore: RootStore
}

const StudentImport: React.FC<Props> = ({ rootStore }) => {
    const {
        register,
        handleSubmit,
        formState: { errors },
    ...
    const onSubmit = async (data: any) => {
        ...
        try {
            const response = await importStudents(postData)
                ...
                <div className="card add_timetable_card ">
                    <div className="card-body add_timetable_cardbody">
                        <div className='d-flex justify-content-between'>
                            <h5 className="card-title"><HistoryBack /> Import Students</h5>
                            <a href='./../../csv/student_import.csv'
